...
import { ServicesGridDemo } from "./services-grid-demo";
import { useComponentSource } from "@/lib/hooks/use-component-source";
import { servicesGridProps } from "./props-data";
    ...
    <div className="space-y-12">
      ...
      <section className="w-full">
        {previewLoading ? (
          ...
          <DemoPreview preview={<ServicesGridDemo />} code={previewCode} />
        )}
      </section>
...
export default ServicesGridContent;
