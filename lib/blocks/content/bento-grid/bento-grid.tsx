...
import { bentoCardProps, bentoGridProps } from "./props-data";
import { BentoGridDemo2 } from "./bento-grid-demo-2";
...
const BentoGridContent = () => {
  ...
  const { code: componentCode, loading: componentLoading } =
    useComponentSource("components/ui/bento-grid.tsx");

  const { code: previewCode, loading: previewLoading } = useComponentSource(
    "lib/blocks/content/bento-grid/bento-grid-demo.tsx"
  );
  const { code: previewExampleCode, loading: previewExampleLoading } = useComponentSource(
    "lib/blocks/content/bento-grid/bento-grid-demo-2.tsx"
  );
  ...
  const cliCommand = `npx shadcn@latest add @gridmantle/bento-grid`;
    ...
    <div className="space-y-12">
      ...
      <section className="w-full">
        {previewLoading ? (
          ...
          <DemoPreview preview={<BentoGridDemo />} code={previewCode} />
        )}
      </section>
      ...
      <section className="w-full ">
        {previewExampleLoading ? (
          ...
          <DemoPreview preview={<BentoGridDemo2 />} code={previewExampleCode} />
        )}
      </section>
