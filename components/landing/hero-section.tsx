...
const HeroSection = () => {
  return (
    <div className="pt-20 sm:pt-28 pb-10 sm:pb-20 px-5 overflow-hidden relative">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* Hero texts */}
        <div className="instrumental text-4xl sm:text-5xl md:text-7xl space-y-1.5">
        ...
        <div className="space-x-1.5 sm:space-x-2.5 py-8 ">
          ...
          <Button  className="rounded-lg cursor-pointer border-2 dark:hover:bg-primary/10 bg-background text-foreground">Browse Blocks</Button>
        </div>
        </div>
    </div>
  );
