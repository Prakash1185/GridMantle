  ...
  return (
    <div className="px-5 relative">
      <div className=" py-10 ">
        ...
        <h1 className="text-3xl sm:text-4xl pt-1">and mark your presence </h1>
        <Button className="rounded-lg cursor-pointer mt-6">View Github<span className="bg-secondary/50 rounded-full p-0.5"><RiGithubFill/></span></Button>
      </div>
